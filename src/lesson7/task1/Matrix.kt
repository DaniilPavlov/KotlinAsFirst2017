...
fun <E> createMatrix(height: Int, width: Int, e: E): Matrix<E> {
    if (height <= 0 || width <= 0) throw IllegalArgumentException("Wrong matrix inputs")
    return MatrixImpl(e, height, width)
}
 ...
 */
class MatrixImpl<E>(e: E, override val height: Int, override val width: Int) : Matrix<E> {
